...
const RentalDetails: React.FC = () => {
  ...
  const businessInfo = {
    ...
    upiQr: "https://i.imgur.com/YourQRImage.jpg"
  };
    ...
    if (invoiceRef.current) {
      ...
      if (printWindow) {
        printWindow.document.write(`
          <html>
            <head>
              <title>Invoice - ${rental.customerName}</title>
              <style>
        ...
        <div ref={invoiceRef} className="space-y-6">
          ...
          <div className="mt-4">
            <div className="flex justify-between items-start">
              <div className="w-1/3">
                <img 
                  src="https://i.ibb.co/qRYLNrQ/upi.jpg" 
                  alt="Payment QR Code"
                  className="w-full max-w-[200px]"
                />
                <p className="text-sm text-center mt-2">Scan to Pay</p>
                <p className="text-sm text-center font-medium">{businessInfo.phone}</p>
              </div>
